        ...
        $.ajax({
                ...
                success: function () {
                    ...
                    $('#subscribe-success > .alert-success')
                        .append("<strong>Merci ! À bientôt !</strong>");
                    $('#subscribe-success > .alert-success')
                        .append('</div>');
                }
            });
    ...
    */
            ...
            $.ajax({
                ...
                success: function () {
                    ...
                    $('#success > .alert-success')
                        .append("<strong>Merci ! Nous vous contacterons dans les plus brefs délais.</strong>");
                    $('#success > .alert-success')
                        .append('</div>');
                ...
                error: function () {
                    ...
                    $('#success > .alert-danger').html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;")
                        .append("</button>");
                    $('#success > .alert-danger').append("<strong>Désolé " + firstName + ", petit problème de réseau.<br>Je te propose de réessayer ou bien de nous envoyer un mail à <a href=\"mailto:contact@heptaward.com?Subject=Demande%20de%20renseignements&body=" + message + "\">contact@heptaward.com</a>.");
    ...
    function init() {
        ...
        var mapOptions = {
            ...
            center: new google.maps.LatLng(49.443719, 1.099621), // Rouen          // How you would like to style the map. 
        ...
        var marker = new google.maps.Marker({
            position: new google.maps.LatLng(49.443719, 1.099621),
            map: map,
